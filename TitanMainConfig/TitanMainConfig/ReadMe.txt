========================================================================
    APLICACIÓN DE CONSOLA: TitanMainConfig Información general 
    del proyecto
========================================================================

AppWizard ha creado esta aplicación TitanMainConfig.

Este archivo contiene un resumen de lo que encontrará en todos los 
archivos que componen la TitanMainConfig aplicación.


TitanMainConfig.vcproj
...
StdAfx.h, StdAfx.cpp
    ...
    precompilado (PCH) denominado TitanMainConfig.pch y un archivo de 
